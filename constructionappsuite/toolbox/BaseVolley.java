package com.example.codetribe1.constructionappsuite.toolbox;
...
import com.example.codetribe1.constructionappsuite.util.MonApp;
import com.example.codetribe1.constructionappsuite.util.Statics;
import com.example.codetribe1.constructionappsuite.util.WebCheck;
import com.example.codetribe1.constructionappsuite.util.WebCheckResult;
...
public class BaseVolley {
        ...
        if (r.isNetworkUnavailable()) {
            showErrorToast(
                    ...
                    ctx.getResources().getString(
                            com.example.codetribe1.constructionappsuite.R.string.error_network_unavailable)
            );
            return false;
        }
    ...
    public static void getRemoteData(String suffix, RequestDTO request,
        ...
        String x = Statics.URL + suffix + json;
        Log.i(LOG, "...sending remote request: ...size: " + x.length() + "...>\n" + Statics.URL + suffix + jj);
        bohaRequest = new BohaRequest(Method.POST, x, onSuccessListener(), onErrorListener());
